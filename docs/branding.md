...
## Bundle id → `asif.nesrullazade.flowParkPuzzle`
...
```
→ iOS bundle id / Android applicationId become `asif.nesrullazade.flowParkPuzzle`.
...
- **iOS:** Xcode → Runner target → *Signing & Capabilities* → **Bundle Identifier** =
  `asif.nesrullazade.flowParkPuzzle`
- **Android:** `android/app/build.gradle` → `applicationId "asif.nesrullazade.flowParkPuzzle"`,
